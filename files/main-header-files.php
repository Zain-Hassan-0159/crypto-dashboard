...
<head>
	...
	<meta name="description" content="PFP - Crypto Admin Dashboard" />
	<meta property="og:title" content="PFP - Crypto Admin Dashboard" />
	<meta property="og:description" content="PFP - Crypto Admin Dashboard" />
	<meta property="og:image" content="http://3.83.88.61/wp-content/uploads/2022/06/PNG-1.png" />
	<meta name="format-detection" content="telephone=no">
    <title>PFP - Crypto Admin Dashboard </title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="http://3.83.88.61/wp-content/uploads/2022/06/PNG-1.png">
	<link rel="stylesheet" href="<?php echo plugin_dir_url( __FILE__ ) ?>assets/vendor/chartist/css/chartist.min.css">
    <link href="<?php echo plugin_dir_url( __FILE__ ) ?>assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="<?php echo plugin_dir_url( __FILE__ ) ?>assets/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a style="justify-content: center;"  href="index.html" class="brand-logo">
				<img class="logo" style="width: 60px;" src="http://3.83.88.61/wp-content/uploads/2022/06/PNG-1.png" alt="PFP">
            </a>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src=/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<?php echo plugin_dir_url( __FILE__ ) ?>assets/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<?php echo plugin_dir_url( __FILE__ ) ?>assets/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<?php echo plugin_dir_url( __FILE__ ) ?>assets/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<?php echo plugin_dir_url( __FILE__ ) ?>assets/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="<?php echo plugin_dir_url( __FILE__ ) ?>assets/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="<?php echo plugin_dir_url( __FILE__ ) ?>assets/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="<?php echo plugin_dir_url( __FILE__ ) ?>assets/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="<?php echo plugin_dir_url( __FILE__ ) ?>assets/images/avatar/1.jpg">
													</div>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<div class="main-profile">
					<div class="image-bx">
						<img src="<?php echo plugin_dir_url( __FILE__ ) ?>assets/images/Untitled-1.jpg" alt="">
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="http://3.83.88.61/#about">About</a></li>
							<li><a href="http://3.83.88.61/#overview">Overview</a></li>
							<li><a href="http://3.83.88.61/#how">How it Works</a></li>
							<li><a href="http://3.83.88.61/#tokens">PFP Tokens</a></li>
						</ul>
				...
				<div class="copyright">
					<p><strong>PFP Crypto Admin Dashboard</strong> © 2021 All Rights Reserved</p>
				</div>
			</div>
        </div>
        <!--**********************************
